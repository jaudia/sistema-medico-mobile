...
const NotificacionesView = () => {
    ...
    React.useEffect(() => {
        AsyncStorage.getItem('datosUsr').then((value) => {
            ...
            fetch(`https://us-central1-aplicacionesdistibuidas1c2020.cloudfunctions.net/AD1C2020/notificaciones?idUsuario=${idUsuario}&tipoUsuario=medico`)
                .then(resp => resp.json())
                .then(datos => {
    ...
    return (
        <View style={styles.subContainer}>
            ...
            <Item
                title={`${docState.data.dia}/${docState.data.mes}/${docState.data.anio} - ${docState.data.descripcion}`}/>
            }
